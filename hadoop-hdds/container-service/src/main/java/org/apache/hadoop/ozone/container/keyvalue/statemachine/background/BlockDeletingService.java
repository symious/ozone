...
public class BlockDeletingService extends BackgroundService {
  ...
  private BlockDeletingServiceMetrics metrics;
    ...
    public ContainerBackgroundTaskResult deleteViaSchema1(
      ...
      try {
        ...
        try (BatchOperation batch = meta.getStore().getBatchHandler()
          ...
          metrics.incrBlockDeletionSuccessCount(deletedBlocksCount);
          metrics.incrBlockDeletionSuccessBytes(releasedBytes);
        }
        ...
        metrics.incrBlockDeletionFailureCount();
        throw exception;
      }
    }
